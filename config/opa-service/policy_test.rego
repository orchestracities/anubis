...
test_authz {
  authz with input as {"user":"1c4f9f82-e5a7-4b32-84ea-a1774531f1d2", "action":"GET", "resource":"*", "tenant":"EKZ", "servicePath":"/test"} with data as data with bearer_token as bearer_token
}
