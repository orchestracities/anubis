...
class Tenant(Base):
    ...
    service_paths = relationship("ServicePath", cascade = "all, delete", back_populates="tenant")
...
#   policies = relationship("Policy")
    parent_id = Column(Integer, ForeignKey('service_paths.id', ondelete="CASCADE"), nullable=True)
