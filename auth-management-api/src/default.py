...
#commodity
DEFAULT_MODES = [READ_MODE_IRI, WRITE_MODE_IRI, APPEND_MODE_IRI, CONTROL_MODE_IRI, DELETE_MODE_IRI]
DEFAULT_AGENTS = [AUTHENTICATED_AGENT_ID, UNAUTHENTICATED_AGENT_IRI, SAME_TENANT_AS_RESOURCE_AGENT_ID]
AGENT_IRI_REGEX = "^"+AGENT_CLASS_IRI+":/[a-zA-Z0-9_/]+$"+"|^"+AGENT_GROUP_IRI+":/[a-zA-Z0-9_/]+$"+"|^"+AGENT_GROUP_IRI+":/[a-zA-Z0-9_/]+$"