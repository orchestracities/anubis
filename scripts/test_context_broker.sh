...
export token=`curl -d "client_id=client1&grant_type=password&username=admin&password=admin" -X POST 'http://keycloak:8080/auth/realms/master/protocol/openid-connect/token' | \
jq '.access_token'`
